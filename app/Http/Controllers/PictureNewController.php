...
class PictureNewController extends BaseController
{
    ...
    public function postAction(Request $request)
    {
        ...
        $headers = [
            ...
            'Content-Disposition' => 'attachment; filename*=UTF-8\'\'' . rawurlencode('test_file'),
            'Expires' => '0',
